...
class _BookingDetailScreenState extends State<BookingDetailScreen> {
  ...
  Widget _action({required BookingDetailResponse bookingResponse}) {
    ...
    } else if (bookingResponse.bookingDetail!.status == BookingStatusKeys.complete && (bookingResponse.bookingDetail!.paymentStatus == null)) {
      return AppButton(
          ...
          children: [
            Stack(
              children: [
                ...
                Positioned(bottom: 16, left: 16, right: 16, child: _action(bookingResponse: snap.data!))
              ],
            ),
